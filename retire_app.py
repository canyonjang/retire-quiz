...
# ---------------------------------------------------------
QUIZ_DATA = [
    {"q": "1. 은퇴설계에서 금리와 (______)는 필요자금 산정과 관리 및 생활비 산출에 영향을 미치게 된다.", "a": "물가"},
    {"q": "2. 주된 일자리에서의 퇴직시기와 가교 일자리에 대한 준비, 퇴직연금과 개인연금의 수급개시연령 조정 등을 고려해 안정적인 은퇴소득을 발생시킬 수 있는 연금(______) 전략을 수립해야 한다.", "a": "공백"},
    {"q": "3. 미국 은퇴확신조사 결과, 기본 노후 생활비, 노후 의료비, 장기(_____)비 순으로 노후 준비에 자신감을 보인 사람이 많았다.", "a": "간병"},
    {"q": "4. 노후준비지원법에 따르면, 노후준비는 노년기에 발생할 수 있는 빈곤, 질병, 무위, (_______) 등에 대하여 미리 대처하는 것이다.", "a": "고독"},
    {"q": "5. 우리나라 노후소득보장제도는 국가-기업-개인에 의한 (____)연금체계이다.", "a": "다층"},
    {"q": "6. 은퇴소득원에서 공적연금의 비중이 낮아지는 추세 속에서 개인연금은 (______)위험을 효과적으로 관리할 수 있는 대안이다.", "a": "장수"},
    {"q": "7. 은퇴소득 확보는 가능한 일찍부터 시작하고 중단없이 장기투자를 실천하여 (______)효과를 최대화하는 것이 가장 중요하다.", "a": "복리"},
]
